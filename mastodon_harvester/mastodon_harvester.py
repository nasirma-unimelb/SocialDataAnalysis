...
parser.add_argument("--couchdb_user", help="ip address of the couchdb server")
parser.add_argument("--couchdb_password", help="ip address of the couchdb server")
args = parser.parse_args()


ADO_API_KEY = args.ado_api_key #'a2a6e2f96a2c94a04661aacc6e394caa'
ADO_LOGIN_URL = args.ado_login_url #'https://api.ado.eresearch.unimelb.edu.au/login'
ADO_TEXT_SEARCH_URL = args.ado_text_search_mastodon_url #'https://api.ado.eresearch.unimelb.edu.au/analysis/textsearch/collections/mastodon'
MASTODON_KEY = args.mastodon_api_key #'f8-yNpSEGxPcQwwz_GxYtET3VumoGZ6KAQAH6bybICE'
COUCHDB_IP = args.couchdb_ip #'localhost'
COUCHDB_user = args.couchdb_user #'admin'
COUCHDB_password= args.couchdb_password #'admin'
...
for i in result:
    ...
    try:
        ...
        Fetcher.harvestAndPush({"sentiment": sentiment})
    except:
        print("Error getting the toot")
        continue
